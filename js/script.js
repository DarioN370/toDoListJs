function adicionarTarefa(){
    ...
    if (tarefa == ""){// duas aspas é considerado vazio  -  Sinal de dois iguais é pra comparar igualdade
        ...
        document.getElementById("mensagem").textContent = mensagemErro  //aqui eu estou exibindo que a tarefa precisa ser adicionada
    } else {
        let mensagemSucesso = "Tarefa adicionada com sucesso.";  // definindo a variavel mensagem com a mensagem que eu quero 
        document.getElementById("mensagem").textContent = mensagemSucesso; //aqui eu estou exibindo que a tarefa foi adicionada
